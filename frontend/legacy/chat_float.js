...
// DEPRECATED: This file is legacy and should not be loaded in production. Use assets/js/chatbot.js instead.
...
async function sendMessage() {
    ...
    try {
        ...
        errorDiv.innerHTML = "❌ Error connecting to chatbot. Please check if the backend server is running on port 8000.";
